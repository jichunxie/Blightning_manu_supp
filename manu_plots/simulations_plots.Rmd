...
```
```{r}
load("~/seedsforsimulations.RData")
```
...
```
```{r Fig.2c simulation 4ct v2 umap}
countdat <- data_sim$counts
rownames(countdat) <- paste("gene", 1:p)  #gene-features
colnames(countdat) <- paste("cell", 1:n)  #cell
...
```
```{r Results Loading}
load("results/GF1ct_10%_1030_results.RData")
GF_Records1ct = Records1ct
load("results/GF4ct_10%_1030_results.RData")
GF_Records4ct = Records4ct
load("results/GF4ct_v2_10%_1030_results.RData")
GF_Records4ct_v2 = Records4ct_v2
load("results/GF8ct_10%_1030_results.RData")
GF_Records8ct = Records8ct


load("results/Simulation1ct_10%_1030_results.RData") #Records1ct
load("results/Simulation4ct_10%_1030_results2.RData") #Records4ct
load("results/Simulation4ct_v2_10%_1030_results2.RData")#Records4ct_v2
load("results/Simulation8ct_10%_1030_results.RData")#Records8ct

load("results/MAST1ct_10%_1030_results.RData")#Traditional_Records1ct_default
load("results/MAST4ct_10%_1030_results.RData")#Traditional_Records4ct
load("results/MAST4ct_v2_10%_1030_results.RData")#Traditional_Records4ct_v2
load("results/MAST8ct_10%_1030_results.RData")#Traditional_Records4ct_v2
...
melt_4ct_traditional = melt(Tradition4ct_Results,id.vars = 'seed', measure.vars=c("FDR","sen", "F1"))
melt_4ct_traditional$source = "S2: DGE"

melt_4ct_v2_traditional = melt(Tradition4ct_v2_Results,id.vars = 'seed', measure.vars=c("FDR","sen", "F1"))
...
melt_4ct_GF = melt(GF4ct_Results,id.vars = 'seed', measure.vars=c("FDR","sen", "F1"))
melt_4ct_GF$source = "S2: GeneFishing"

melt_4ct_v2_GF = melt(GF4ct_v2_Results,id.vars = 'seed', measure.vars=c("FDR","sen", "F1"))
...
geom_boxplot(aes(x=factor(xlabs,level=c('FDR', 'Sensitivity','F1')), y=value, color = method),position = position_dodge2(preserve = "single"),width = 0.7,lwd = 1.1)  +
